...
function PostsPage() {
    ...
    return (
        <div className="space-y-12">
            ...
            <section
                ref={list.ref}
                className={`fade-up ${list.isVisible ? 'visible' : ''} space-y-1`}>
                {isLoading ? (
                    ...
                    posts.map((post) => (
                        <Link
                            ...
                            <div className="space-y-1">
                                <p className="text-xl font-medium text-gray-900 dark:text-white group-hover:translate-x-1 transition-transform duration-200">
                                    {post.title}
                                </p>
                            ...
                            <span className="text-sm text-gray-400 dark:text-gray-500 shrink-0 ml-6 group-hover:opacity-70 transition-opacity">
                {post.date}
              </span>
                        </Link>
                    ))
